                ...
                <table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff; border:1px solid #e0dcd3; border-radius:6px; padding:40px;">
                    <tr>
                        <td>
                            ...
                            <h2 style="margin:0 0 16px; color:#1a1a1a;">A donor has been found</h2>
                            <p style="font-size:15px; line-height:1.6; color:#444; margin:0 0 16px;">
                                Hi {{ $bloodRequest->requester_name }}, good news — we've matched a potential
                                <strong>{{ $bloodRequest->blood_group }}</strong> donor to your blood request and
                                they've been notified. Once they confirm, we'll email you their contact details
                                so you can coordinate directly.
                            </p>
                            <p style="font-size:15px; line-height:1.6; color:#444; margin:0 0 28px;">
                                We've attached a PDF with your reference code — keep it handy, you'll need to
                                show it at the hospital when you go to receive blood.
                            </p>
